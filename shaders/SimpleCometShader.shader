...
void vertex() {
	...
	float b = UV2.y;
	float f = dot(vec4(0.3*sin(b*2.0),0.3*cos(b*2.0),0.4*sin(b*3.0),0.4*cos(b*3.0)),ic1);
	f += dot(vec4(0.2*sin(b*4.0),0.2*cos(b*4.0),0.2*sin(b*5.0),0.2*cos(b*5.0)),ic2);
	
	float a = UV2.x;
	float g = dot(vec4(0.3*sin(a*2.0),0.3*cos(a*2.0),0.4*sin(a*3.0),0.4*cos(a*3.0)),ic3);
	g += dot(vec4(0.2*sin(4.0*a),0.2*cos(4.0*a),0.2*sin(a*5.0),0.2*cos(a*5.0)),ic4);
