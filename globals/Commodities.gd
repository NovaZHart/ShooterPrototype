...
func shipyard_data_tables() -> ManyProducts:
	...
	var data = [ # name, quantity, value, fine, density, tags
		...
		[ 'res://weapons/IACivilian/DuteriumFluorideLaser.tscn', 40, 9000, 9000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/DuteriumFluorideLaserTurret.tscn', 25, 16000, 16000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/BlueMissileLauncher.tscn', 40, 13000, 13000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/BlueRapidMissileLauncher.tscn', 40, 29000, 29000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/GammaRayLaser.tscn', 40, 22000, 22000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/GreenMissileLauncher.tscn', 40, 26000, 26000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/GammaRayLaserTurret.tscn', 40, 39000, 39000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/PlasmaTurret.tscn', 40, 36000, 36000, 0, 'plasma', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/PlasmaGun2x3.tscn', 40, 31000, 31000, 0, 'plasma', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/PlasmaGun1x4.tscn', 40, 26000, 26000, 0, 'plasma', 'weapon', 'terran' ],
		[ 'res://weapons/IACivilian/PlasmaBallLauncher.tscn', 40, 54000, 54000, 0, 'plasma', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/Old/BigRedMissileLauncher.tscn', 25, 96000, 96000, 0, 'explosive', 'homing', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher1x3.tscn', 40, 11000, 11000, 0, 'pierce', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher1x4.tscn', 40, 23000, 23000, 0, 'pierce', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher2x4.tscn', 40, 48000, 48000, 0, 'pierce', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher3x4.tscn', 40, 119000, 119000, 0, 'pierce', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncherTurret3x3.tscn', 40, 46000, 46000, 0, 'pierce', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncherTurret4x4.tscn', 40, 128000, 128000, 0, 'pierce', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun1x3.tscn', 40, 12000, 12000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun1x4.tscn', 40, 24500, 24500, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun2x4.tscn', 40, 51000, 51000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun3x4.tscn', 40, 123000, 123000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/ElectronTurret3x3.tscn', 40, 48000, 48000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/ElectronTurret4x4.tscn', 40, 141000, 141000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun2x4.tscn', 40, 51000, 51000, 0, 'impact', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailTurret.tscn', 40, 48000, 48000, 0, 'impact', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun1x4.tscn', 40, 24500, 24500, 0, 'impact', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun1x3.tscn', 40, 12000, 12000, 0, 'impact', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MassDriver.tscn', 40, 135000, 135000, 0, 'impact', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/FrontierMilitia/MassDriverTurret.tscn', 40, 154000, 154000, 0, 'impact', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/IAPolice/GreyMissileLauncher.tscn', 40, 79000, 79000, 0, 'explosive', 'homing', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/IAPolice/RetributionMissileLauncher.tscn', 25, 124000, 124000, 0, 'explosive', 'homing', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/IAPolice/JusticeMissileLauncher.tscn', 25, 47000, 47000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/IAPolice/CyclotronTurret4x4.tscn', 40, 97000, 97000, 0, 'particle', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/IAPolice/CyclotronTurret3x3.tscn', 40, 55000, 55000, 0, 'particle', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/IAPolice/LinearAccelerator3x4.tscn', 40, 135000, 135000, 0, 'particle', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/IAPolice/LinearAccelerator2x4.tscn', 40, 81000, 81000, 0, 'particle', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/IAPolice/LinearAccelerator1x4.tscn', 40, 39000, 38000, 0, 'particle', 'weapon', 'terran', ],
		[ 'res://weapons/IAPolice/NuclearPumpedLaser1x4.tscn', 40, 38000, 38000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/IAPolice/NuclearPumpedLaser3x4.tscn', 40, 127000, 127000, 0, 'laser', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/IAPolice/NuclearPumpedLaser2x4.tscn', 40, 71000, 71000, 0, 'laser', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/IAPolice/NuclearPumpedLaserTurret4x4.tscn', 25, 94000, 94000, 0, 'laser', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/IAPolice/NuclearPumpedLaserTurret3x3.tscn', 25, 53000, 53000, 0, 'laser', 'weapon', 'terran', 'large' ],
		...
		[ 'res://equipment/defense/GravityControlSystem.tscn', 40, 41000, 41000, 0, 'equipment', 'terran' ],
		[ 'res://equipment/defense/ElectroMagneticDampener.tscn', 40, 46000, 46000, 0, 'equipment', 'terran' ],
		[ 'res://equipment/defense/EnvironmentalControlSystem.tscn', 40, 39000, 39000, 0, 'equipment', 'terran' ],
		[ 'res://equipment/defense/EntertainmentNetwork.tscn', 40, 31000, 31000, 0, 'equipment', 'terran' ],
		[ 'res://equipment/defense/AblativeBiogelExcreter.tscn', 40, 51000, 51000, 0, 'equipment', 'terran' ],
		[ 'res://equipment/engines/FrontierEngine2x2.tscn', 40, 18000, 18000, 0, 'engine', 'terran/frontier' ],
		[ 'res://equipment/engines/FrontierEngine2x4.tscn', 40, 41000, 41000, 0, 'engine', 'terran/frontier' ],
		[ 'res://equipment/engines/FrontierEngine4x4.tscn', 40, 89000, 89000, 0, 'engine', 'terran/frontier' ],
		...
		[ 'res://equipment/repair/FrontierRepair2x2.tscn', 40, 45000, 45000, 0, 'equipment', 'power', 'structure', 'terran' ],
		[ 'res://equipment/repair/Shield1x3.tscn', 40, 24500, 24500, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/Shield2x1.tscn', 40, 16000, 16000, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/Shield1x1.tscn', 40, 7500, 7500, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/FrontierShield1x2.tscn', 40, 29000, 29000, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/ShieldCapacitors1x2.tscn', 40, 21000, 29000, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/Shield2x2.tscn', 40, 35000, 35000, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/FrontierShield2x3.tscn', 40, 85000, 85000, 0, 'equipment', 'shield', 'terran' ],
		[ 'res://equipment/repair/ShieldCapacitors2x3.tscn', 40, 65000, 85000, 0, 'equipment', 'shield', 'terran' ],
		...
		[ 'res://equipment/power/SmallReactor.tscn', 40, 31000, 31000, 0, 'equipment', 'terran', 'power' ],
		[ 'res://equipment/power/MediumReactor.tscn', 40, 58000, 58000, 0, 'equipment', 'terran', 'power' ],
		[ 'res://equipment/power/LargeReactor.tscn', 40, 119000, 119000, 0, 'equipment', 'terran', 'power', 'large' ],
		[ 'res://equipment/cooling/AdiabaticDemagnitizationCooler.tscn', 40, 41000, 41000, 0, 'equipment', 'terran', 'cooling' ],
		...
		[ 'res://equipment/cooling/OrganicNanofluidCoolant.tscn', 40, 19000, 19000, 0, 'equipment', 'terran', 'cooling' ],
		[ 'res://ships/BannerShip/BannerShipHull.tscn', 3, 394000, 394000, 0, 'hull/civilian/advertisment', 'terran', 'large' ],
		[ 'res://ships/Police/Popoto.tscn', 9, 108000, 108000, 0, 'hull/combat/interceptor', 'terran' ],
		[ 'res://ships/Police/Bufeo.tscn', 4, 228000, 228000, 0, 'hull/combat/warship', 'terran' ],
		[ 'res://ships/Police/Orca.tscn', 2, 581000, 581000, 0, 'hull/combat/warship', 'terran', 'large' ],
		[ 'res://ships/Police/Ankylorhiza.tscn', 1, 1308000, 1308000, 0, 'hull/combat/capital', 'terran', 'capital' ],
		[ 'res://ships/FrontierMilitia/Eagle.tscn', 3, 133000, 133000, 0, 'hull/combat/warship', 'terran' ],
		[ 'res://ships/FrontierMilitia/Condor.tscn', 1, 793000, 793000, 0, 'hull/combat/capital', 'terran', 'capital' ],
		[ 'res://ships/FrontierMilitia/Peregrine.tscn', 12, 75000, 75000, 0, 'hull/combat/interceptor', 'terran' ],
		[ 'res://ships/FrontierMilitia/Raven.tscn', 3, 141000, 141000, 0, 'hull/combat/warship', 'terran' ],
		[ 'res://ships/SmallCivilian/Husky.tscn', 2, 235000, 235000, 0, 'hull/cargo/cargo', 'terran' ],
		[ 'res://ships/SmallCivilian/Qimmeq.tscn', 2, 69000, 69000, 0, 'hull/cargo/cargo', 'terran' ],
		[ 'res://ships/Starliner/Thoroughbred.tscn', 2, 875000, 875000, 0, 'hull/cargo/cargo', 'terran' ],
		[ 'res://ships/SmallCivilian/Samoyed.tscn', 2, 31000, 31000, 0, 'hull/cargo/cargo', 'terran' ],
		[ 'res://ships/CargoPodShips/Monopod.tscn', 2, 133000, 133000, 0, 'hull/cargo/container', 'terran' ],
		[ 'res://ships/CargoPodShips/Bipod.tscn', 2, 252000, 252000, 0, 'hull/cargo/container', 'terran', 'large' ],
		[ 'res://ships/CargoPodShips/Hexapod.tscn', 2, 745000, 745000, 0, 'hull/cargo/container', 'terran', 'capital' ],
	]
