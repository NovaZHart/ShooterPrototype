...
func shipyard_data_tables() -> ManyProducts:
	...
	var data = [ # name, quantity, value, fine, density, tags
		...
		[ 'res://equipment/engines/FissionEngine.tscn', 40, 26000, 26000, 0, 'engine', 'terran', 'large' ],
		[ 'res://equipment/engines/FusionEngine.tscn', 40, 53000, 53000, 0, 'engine', 'terran', 'large' ],
		...
		[ 'res://equipment/power/BioelectricGenerator.tscn', 40, 19000, 19000, 0, 'terran', 'equipment', 'power', 'organic' ],
		...
		[ 'res://equipment/power/LargeReactor.tscn', 40, 103000, 103000, 0, 'equipment', 'terran', 'power', 'large' ],
		[ 'res://equipment/cooling/AdiabaticDemagnitizationCooler.tscn', 40, 31000, 31000, 0, 'equipment', 'terran', 'cooling' ],
		[ 'res://equipment/cooling/SmallOpticalCooler.tscn', 40, 8000, 8000, 0, 'equipment', 'terran', 'cooling' ],
		[ 'res://equipment/cooling/LargeOpticalCooler.tscn', 40, 16000, 16000, 0, 'equipment', 'terran', 'cooling' ],
		[ 'res://equipment/cooling/OrganicNanofluidCoolant.tscn', 40, 25000, 25000, 0, 'equipment', 'terran', 'cooling' ],
