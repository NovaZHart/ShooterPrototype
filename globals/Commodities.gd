...
func shipyard_data_tables() -> ManyProducts:
	...
	var data = [ # name, quantity, value, fine, density, tags
		...
		[ 'res://weapons/Old/OrangeSpikeGun.tscn', 40, 11000, 11000, 0, 'particle', 'weapon', 'terran' ],
		[ 'res://weapons/Old/LargeOrangeSpikeGun.tscn', 40, 27000, 27000, 0, 'particle', 'weapon', 'terran' ],
		[ 'res://weapons/Old/OrangeSpikeTurret.tscn', 40, 31000, 31000, 0, 'particle', 'weapon', 'terran' ],
		...
		[ 'res://weapons/Old/PurpleHomingGun.tscn', 40, 54000, 54000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		...
		[ 'res://weapons/FrontierMilitia/ElectronTurret.tscn', 40, 48000, 48000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun2x4.tscn', 40, 51000, 51000, 0, 'kinetic', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailTurret.tscn', 40, 48000, 48000, 0, 'kinetic', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun1x4.tscn', 40, 24500, 24500, 0, 'kinetic', 'weapon', 'terran' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun1x3.tscn', 40, 12000, 12000, 0, 'kinetic', 'weapon', 'terran' ],
		...
		[ 'res://weapons/FrontierMilitia/MassDriver.tscn', 40, 135000, 135000, 0, 'kinetic', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/FrontierMilitia/MassDriverTurret.tscn', 40, 154000, 154000, 0, 'kinetic', 'weapon', 'terran', 'capital' ],
