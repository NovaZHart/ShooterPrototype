...
func shipyard_data_tables() -> ManyProducts:
	...
	var data = [ # name, quantity, value, fine, density, tags
		...
		[ 'res://weapons/Old/BigRedMissileLauncher.tscn', 25, 96000, 96000, 0, 'explosive', 'homing', 'weapon', 'terran', 'capital', 'license/alliance_military' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher1x3.tscn', 40, 11000, 11000, 0, 'pierce', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher1x4.tscn', 40, 23000, 23000, 0, 'pierce', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher2x4.tscn', 40, 48000, 48000, 0, 'pierce', 'weapon', 'terran', 'large', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncher3x4.tscn', 40, 119000, 119000, 0, 'pierce', 'weapon', 'terran', 'capital', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncherTurret3x3.tscn', 40, 46000, 46000, 0, 'pierce', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/SpikeLauncherTurret4x4.tscn', 40, 128000, 128000, 0, 'pierce', 'weapon', 'terran', 'capital', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun1x3.tscn', 40, 12000, 12000, 0, 'charge', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun1x4.tscn', 40, 24500, 24500, 0, 'charge', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun2x4.tscn', 40, 51000, 51000, 0, 'charge', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/ElectronGun3x4.tscn', 40, 123000, 123000, 0, 'charge', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/ElectronTurret3x3.tscn', 40, 48000, 48000, 0, 'charge', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/ElectronTurret4x4.tscn', 40, 141000, 141000, 0, 'charge', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun2x4.tscn', 40, 51000, 51000, 0, 'impact', 'weapon', 'terran', 'large', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailTurret.tscn', 40, 48000, 48000, 0, 'impact', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun1x4.tscn', 40, 24500, 24500, 0, 'impact', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/MagneticRailGun1x3.tscn', 40, 12000, 12000, 0, 'impact', 'weapon', 'terran', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/MassDriver.tscn', 40, 135000, 135000, 0, 'impact', 'weapon', 'terran', 'capital', 'license/frontier_militia' ],
		[ 'res://weapons/FrontierMilitia/MassDriverTurret.tscn', 40, 154000, 154000, 0, 'impact', 'weapon', 'terran', 'capital', 'license/frontier_militia' ],
		[ 'res://weapons/IAPolice/GreyMissileLauncher.tscn', 40, 79000, 79000, 0, 'explosive', 'homing', 'weapon', 'terran', 'large', 'license/alliance_police' ],
		[ 'res://weapons/IAPolice/RetributionMissileLauncher.tscn', 25, 124000, 124000, 0, 'explosive', 'homing', 'weapon', 'terran', 'capital', 'license/alliance_police' ],
		[ 'res://weapons/IAPolice/JusticeMissileLauncher.tscn', 25, 47000, 47000, 0, 'explosive', 'homing', 'weapon', 'terran', 'license/alliance_police' ],
		[ 'res://weapons/IAPolice/CyclotronTurret4x4.tscn', 40, 97000, 97000, 0, 'particle', 'weapon', 'terran', 'capital', 'license/alliance_police' ],
		[ 'res://weapons/IAPolice/CyclotronTurret3x3.tscn', 40, 55000, 55000, 0, 'particle', 'weapon', 'terran', 'large', 'license/alliance_police' ],
		[ 'res://weapons/IAPolice/LinearAccelerator3x4.tscn', 40, 135000, 135000, 0, 'particle', 'weapon', 'terran', 'capital', 'license/alliance_police' ],
		[ 'res://weapons/IAPolice/LinearAccelerator2x4.tscn', 40, 81000, 81000, 0, 'particle', 'weapon', 'terran', 'large', 'license/alliance_police' ],
		...
		[ 'res://weapons/IAPolice/NuclearPumpedLaser3x4.tscn', 40, 127000, 127000, 0, 'laser', 'weapon', 'terran', 'capital', 'license/alliance_police' ],
		...
		[ 'res://equipment/engines/FrontierEngine2x4.tscn', 40, 41000, 41000, 0, 'engine', 'terran/frontier', 'license/frontier_militia' ],
		[ 'res://equipment/engines/FrontierEngine4x4.tscn', 40, 89000, 89000, 0, 'engine', 'terran/frontier', 'license/frontier_militia' ],
		...
		[ 'res://equipment/engines/IonEngine2x4.tscn', 40, 30000, 30000, 0, 'engine', 'terran', 'large', 'licence/alliance_civilian' ],
		[ 'res://equipment/engines/IonEngine4x4.tscn', 40, 61000, 61000, 0, 'engine', 'terran', 'large', 'licence/alliance_civilian' ],
		...
		[ 'res://equipment/divinity/DivinityDrive.tscn', 40, 1, 1, 0, 'engine', 'terran', 'license/god_mode' ],
		[ 'res://equipment/divinity/DivinityOrb.tscn', 40, 1, 1, 0, 'equipment', 'terran', 'license/god_mode' ],
		...
		[ 'res://equipment/repair/FrontierRepair2x2.tscn', 40, 45000, 45000, 0, 'equipment', 'power', 'structure', 'terran', 'license/frontier_militia' ],
		...
		[ 'res://equipment/cooling/OrganicNanofluidCoolant.tscn', 40, 19000, 19000, 0, 'equipment', 'terran', 'cooling', 'licence/alliance_civilian' ],
		...
		[ 'res://ships/FrontierMilitia/Peregrine.tscn', 12, 75000, 75000, 0, 'hull/combat/interceptor', 'terran', 'license/frontier_militia' ],
		[ 'res://ships/FrontierMilitia/Raven.tscn', 3, 141000, 141000, 0, 'hull/combat/warship', 'terran', 'license/frontier_militia' ],
		[ 'res://ships/SmallCivilian/Husky.tscn', 2, 235000, 235000, 0, 'hull/cargo/cargo', 'terran', 'license/alliance_advanced' ],
		[ 'res://ships/SmallCivilian/Qimmeq.tscn', 2, 69000, 69000, 0, 'hull/cargo/cargo', 'terran', 'license/alliance_civilian' ],
		[ 'res://ships/Starliner/Thoroughbred.tscn', 2, 875000, 875000, 0, 'hull/cargo/cargo', 'terran', 'license/alliance_advanced' ],
		[ 'res://ships/SmallCivilian/Samoyed.tscn', 2, 31000, 31000, 0, 'hull/cargo/cargo', 'terran', 'license/alliance_civilian' ],
		[ 'res://ships/CargoPodShips/Monopod.tscn', 2, 133000, 133000, 0, 'hull/cargo/container', 'terran', 'license/alliance_civilian' ],
		[ 'res://ships/CargoPodShips/Bipod.tscn', 2, 252000, 252000, 0, 'hull/cargo/container', 'terran', 'large', 'license/alliance_civilian' ],
		[ 'res://ships/CargoPodShips/Hexapod.tscn', 2, 745000, 745000, 0, 'hull/cargo/container', 'terran', 'capital', 'license/alliance_advanced' ],
	]
