...
func shipyard_data_tables() -> ManyProducts:
	...
	var data = [ # name, quantity, value, fine, density, tags
		[ 'res://weapons/DuteriumFluorideLaser.tscn', 40, 9000, 9000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/DuteriumFluorideLaserTurret.tscn', 25, 16000, 16000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/BlueMissileLauncher.tscn', 40, 13000, 13000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/BlueRapidMissileLauncher.tscn', 40, 29000, 29000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/GammaRayLaser.tscn', 40, 22000, 22000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/GreenMissileLauncher.tscn', 40, 26000, 26000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/GammaRayLaserTurret.tscn', 40, 39000, 39000, 0, 'laser', 'weapon', 'terran' ],
		...
		[ 'res://weapons/PlasmaBallLauncher.tscn', 40, 54000, 54000, 0, 'plasma', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/PurpleHomingGun.tscn', 40, 54000, 54000, 0, 'explosive', 'homing', 'weapon', 'terran' ],
		[ 'res://weapons/ElectronGun1x3.tscn', 40, 12000, 12000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/ElectronGun1x4.tscn', 40, 24500, 24500, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/ElectronGun2x4.tscn', 40, 51000, 51000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/ElectronGun3x4.tscn', 40, 123000, 123000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/ElectronTurret.tscn', 40, 48000, 48000, 0, 'charge', 'weapon', 'terran' ],
		[ 'res://weapons/MagneticRailGun2x4.tscn', 40, 51000, 51000, 0, 'kinetic', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/MagneticRailTurret.tscn', 40, 48000, 48000, 0, 'kinetic', 'weapon', 'terran' ],
		[ 'res://weapons/MagneticRailGun1x4.tscn', 40, 24500, 24500, 0, 'kinetic', 'weapon', 'terran' ],
		[ 'res://weapons/MagneticRailGun1x3.tscn', 40, 12000, 12000, 0, 'kinetic', 'weapon', 'terran' ],
		[ 'res://weapons/GreyMissileLauncher.tscn', 40, 79000, 79000, 0, 'explosive', 'homing', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/BigRedMissileLauncher.tscn', 25, 96000, 96000, 0, 'explosive', 'homing', 'weapon', 'terran', 'capital' ],
		...
		[ 'res://weapons/LinearAccelerator2x4.tscn', 40, 81000, 81000, 0, 'particle', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/LinearAccelerator1x4.tscn', 40, 39000, 38000, 0, 'particle', 'weapon', 'terran', ],
		[ 'res://weapons/NuclearPumpedLaser1x4.tscn', 40, 38000, 38000, 0, 'laser', 'weapon', 'terran' ],
		[ 'res://weapons/NuclearPumpedLaser3x4.tscn', 40, 127000, 127000, 0, 'laser', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/NuclearPumpedLaser2x4.tscn', 40, 71000, 71000, 0, 'laser', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/NuclearPumpedLaserTurret4x4.tscn', 25, 94000, 94000, 0, 'laser', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/NuclearPumpedLaserTurret3x3.tscn', 25, 53000, 53000, 0, 'laser', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/AntiMissile2x2.tscn', 40, 13000, 13000, 0, 'antimissile', 'weapon', 'terran' ],
		[ 'res://weapons/AntiMissile3x3.tscn', 40, 32000, 32000, 0, 'antimissile', 'weapon', 'terran' ],
