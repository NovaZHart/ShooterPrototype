...
func shipyard_data_tables() -> ManyProducts:
	...
	var data = [ # name, quantity, value, fine, density, tags
		...
		[ 'res://weapons/BlueLoopTurret3x3.tscn', 40, 55000, 55000, 0, 'particle', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/ParticleGun3x4.tscn', 40, 135000, 135000, 0, 'particle', 'weapon', 'terran', 'capital' ],
		[ 'res://weapons/BigParticleGun.tscn', 40, 81000, 81000, 0, 'particle', 'weapon', 'terran', 'large' ],
		[ 'res://weapons/SmallParticleGun.tscn', 40, 39000, 38000, 0, 'particle', 'weapon', 'terran', ],
		...
		[ 'res://weapons/NuclearPumpedLaserTurret.tscn', 25, 94000, 94000, 0, 'laser', 'weapon', 'terran', 'capital' ],
